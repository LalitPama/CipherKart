...
import { useRouter } from "next/navigation"; // Added router to trigger navigation
...
const products = [
  {
    ...
    category: "headphone", // Added category
  },
  {
    id: 2,
    ...
    category: "earphone", // Added category
  },
  {
    id: 3,
          ...
          <div key={id} className="relative group">
            ...
            <div className="group-hover:-translate-y-4 transition duration-300 absolute bottom-8 left-8 text-white space-y-2">
              ...
              <button
                ...
                onClick={() => handleBuyNow(category)} // Buy now triggers search
              >
                Buy now{" "}
                <Image
                  className="h-3 w-3"
